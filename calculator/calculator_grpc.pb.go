...
type CalculatorClient interface {
	Calculate(ctx context.Context, in *Expression, opts ...grpc.CallOption) (*Result, error)
}
...
func (c *calculatorClient) Calculate(ctx context.Context, in *Expression, opts ...grpc.CallOption) (*Result, error) {
...
type CalculatorServer interface {
	Calculate(context.Context, *Expression) (*Result, error)
...
func (UnimplementedCalculatorServer) Calculate(context.Context, *Expression) (*Result, error) {
